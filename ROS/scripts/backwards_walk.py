...
#
# Python script that has Valkyrie walk backwards a given number of steps
#
...
def straightWalk(steps, direction):
...
if __name__ == '__main__':
    ...
    try:
        ...
        rospy.init_node('backwards_walk')
